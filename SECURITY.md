...
The Movie-list-API project follows the below version support policy:
...
If you discover a security vulnerability within Movie-list-API, please send an email to vadymakohon@gmail.com. All security vulnerabilities will be promptly addressed.
...
Thank you for helping to keep Movie-list-API secure.
